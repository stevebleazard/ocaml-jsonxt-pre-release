...
module Make (Compliant_lex : Compliant_lex.S) : Compliant_lex.Lex = struct
...
rule read =
  ...
  | ":"
    { COLON }
  | "-" inifinity
    { Compliant_lex.lex_number NEGINFINITY }
  | inifinity
    { Compliant_lex.lex_number INFINITY }
  | "+" inifinity
    { Compliant_lex.lex_number INFINITY }
  | nan
    { Compliant_lex.lex_number NAN }
  | integer
    {
